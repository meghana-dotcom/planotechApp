...
class _AttendancePageState extends State<AttendancePage> {
  ...
  Future<void> _fetchAttendanceData() async {
    ...
    final response = await http.post(Uri.parse('http://13.201.213.5:4040/admin/fetchemployeeattendancebyemployeeid?empId=${widget.empId}'));
          ...
          try {
            ...
            if (dateParts.length == 3) {
              ...
              if (day != null && month != null && year != null) {
                ...
                return attendanceDate.toLocal().isAtSameMomentAs(_selectedDate.toLocal());
              }
            }
            return false;
          } catch (e) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        SizedBox(height: 4.0),
                        Text('Day : ${attendance['day']}',style: TextStyle(fontWeight: FontWeight.bold)),
                        SizedBox(height: 4.0),
                        Text(
                        ...
                        SizedBox(height: 4.0),
                        Text('Address: ${attendance['address']}', style: TextStyle(fontWeight: FontWeight.bold)),
                        SizedBox(height: 4.0),
                        Text('attendanceStatus: ${attendance['attendanceStatus']} ',style: TextStyle(fontWeight: FontWeight.bold)),
